    ...
    >
      ...
      <div className="relative z-10 flex-1 min-h-0 flex items-center justify-center pt-24">
        ...
        <Link href={`/pitch/${id}`} className="flex flex-col items-center">
          ...
          <div className="w-4 h-4 -mt-2 rounded-full bg-brick flex items-center justify-center shadow">
        ...
        <Link href={`/pitch/${id}`} className="flex flex-col items-center gap-1 group">
          <div className="w-10 h-10 rounded-full bg-cream/90 text-ink shadow-md flex items-center justify-center group-hover:bg-cream transition-all">
        ...
        <button onClick={handleShare} className="flex flex-col items-center gap-1 group">
          <div className={`w-10 h-10 rounded-full shadow-md flex items-center justify-center transition-all ${
